	...
	<div class="navbar-container" id="navbar-container">
		<div class="navbar-header pull-left">
			<a href="#" class="navbar-brand"> <small> <i
					class="icon-leaf"></i> XCHEN TourPal Management System
			</small>
			</a>
			<!-- /.brand -->
		</div>
			...
			<ul class="nav ace-nav">
				...
				<li class="light-blue"><a data-toggle="dropdown" href="#"
					class="dropdown-toggle"> <img class="nav-user-photo"
						...
						class="user-info"> <small>Welcome,${userinfo.userName }</small>
					...
					<ul
						...
						<li class="divider"></li>
						<li><a href="jsp/admin/login.jsp"> <i class="icon-off"></i>
								Sign out
						</a></li>
					</ul></li> 
			</ul>
	...
	<div class="main-container-inner">
		...
		<div class="sidebar" id="sidebar">
			...
			<ul class="nav nav-list">
				<li class="active"><a href="jsp/admin/main.jsp"
					target="mainframe"> <i class="icon-dashboard"></i> <span
						class="menu-text"> Console </span>
				</a></li>
				<li><a href="javascript:void(0)" target="mainframe"
					class="dropdown-toggle"> <i class="icon-desktop"></i> <span
						class="menu-text"> Control panel </span> <b class="arrow icon-angle-down"></b>
				</a>

					<ul class="submenu">

						<li><a href="jsp/admin/userinfo/userinfo_list.jsp" target="mainframe"> <i
								class="icon-double-angle-right"></i> User management
						</a></li>
						<li><a href="jsp/admin/viewinfo/viewinfo_add.jsp"
							target="mainframe"> <i class="icon-double-angle-right"></i>
								Add view
						</a></li>

						<li><a href="viewinfo/list.do" target="mainframe"> <i
								class="icon-double-angle-right"></i> Query view
						</a></li>
					</ul></li>
